...
figma와 slack을 통해 4명이 기획을 함께 진행했고, 디자인부터 개발은 각자 진행하였습니다. 배포는 github pages를 이용하였습니다.`,
  ...
  },
  {
    ...
    state_management_data_communication: "Zustand / ReactQuery / Fetch Api",
    library_service: "",
    tool: "Git / Github / Notion / Slack / Figma",
...
컴포넌트의 종속성에 따라, 많게는 6번 정도의 props drilling이 발생했고, 파일구조 또한 따로 정해놓지 않은 상태로 하다보니 타입을 지정하는 것 조차도 굉장히 번거롭고 오류도 많이 발생했습니다.
